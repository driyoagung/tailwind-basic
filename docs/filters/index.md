...
```html
<!-- Grid Gambar dengan berbagai filter -->
<div class="grid grid-cols-2 md:grid-cols-4 gap-4">
  
  <div>
    <p class="text-xs mb-1 font-bold text-center">Normal</p>
    <img src="https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400" class="w-full h-32 object-cover rounded-lg">
  </div>
  
  <div>
    <p class="text-xs mb-1 font-bold text-center">Grayscale (Hitam Putih)</p>
    <img src="https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400" class="w-full h-32 object-cover rounded-lg grayscale">
  </div>
  
  <div>
    <p class="text-xs mb-1 font-bold text-center">Hover untuk Jelas</p>
    <img src="https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400" class="w-full h-32 object-cover rounded-lg blur-sm hover:blur-none transition cursor-pointer">
  </div>
  
  <div>
    <p class="text-xs mb-1 font-bold text-center">Kecerahan (Brightness)</p>
    <img src="https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400" class="w-full h-32 object-cover rounded-lg brightness-50 hover:brightness-110 transition cursor-pointer">
  </div>
...
```html
<div class="flex items-center justify-around bg-white p-8 rounded-xl border">
  ...
  <div class="text-center">
    <p class="text-sm font-bold mb-4">Drop Shadow (Mengikuti Bentuk Ikon)</p>
    <!-- Logo panah melengkung dengan Drop Shadow -->
    <svg class="w-16 h-16 text-blue-500 drop-shadow-xl mx-auto" fill="currentColor" viewBox="0 0 24 24">
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm5 11h-4v4h-2v-4H7v-2h4V7h2v4h4v2z"></path>
    </svg>
  </div>
...
```html
<!-- Container Utama (Gambar Pemandangan) -->
<div class="relative bg-[url('https://images.unsplash.com/photo-1506744626753-14072229246a?w=600')] bg-cover bg-center h-64 rounded-xl flex items-center justify-center p-6">
  
  <!-- Efek Kaca (Glassmorphism) -->
  <!-- bg-white/30 membuat putih transparan -->
  <!-- backdrop-blur-md memburamkan apa yang ada di baliknya -->
  <div class="bg-white/30 backdrop-blur-md border border-white/40 shadow-xl rounded-2xl p-8 max-w-sm w-full text-center">
