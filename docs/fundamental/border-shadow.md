---
title: Border & Shadow
description: Cara menggunakan border, border radius, outline, ring, dan box shadow di Tailwind CSS.
---
...
<Preview :html='`<div class="grid grid-cols-3 gap-4 text-center font-medium">
...
<Preview :html='`<div class="flex flex-wrap gap-8 p-4">
  <button class="bg-blue-500 text-white px-4 py-2 rounded ring-4 ring-blue-300">
    Tombol dengan Ring
  </button>
  <input type="text" placeholder="Fokus ke input ini" class="border bg-white px-4 py-2 rounded focus:outline-none focus:ring-2 focus:ring-green-500" />
</div>`' />
...
<Preview :html='`<div class="grid grid-cols-2 md:grid-cols-4 gap-6 bg-gray-50 p-6 rounded-lg">
