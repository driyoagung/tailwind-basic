---
title: "Background Lanjutan"
description: "Pelajari background opacity, gradient, dan background image di Tailwind CSS."
---
...
<Preview :html='`<div class="relative bg-[url(https://images.unsplash.com/photo-1506744626753-14072229246a?w=600)] bg-cover bg-center h-48 rounded-xl p-4 flex items-end">
...
<Preview :html='`<div class="grid grid-cols-2 gap-4">
  <!-- 2 Warna -->
