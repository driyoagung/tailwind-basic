---
title: Overflow & Object Fit
description: Menangani konten meluber dengan overflow dan menjaga rasio gambar dengan object-fit.
---
...
<Preview :html='`<div class="grid grid-cols-2 gap-4 h-48">
  <!-- Hidden -->
...
<Preview :html='`<div class="grid grid-cols-3 gap-4 text-center text-sm font-bold">
  <div>
