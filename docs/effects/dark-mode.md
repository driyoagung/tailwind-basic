...
```html
<!-- Elemen ini akan putih di mode terang, hitam di mode gelap -->
<div class="bg-white dark:bg-slate-800 rounded-lg px-6 py-8 ring-1 ring-slate-900/5 shadow-xl">
  ...
  <p class="text-slate-500 dark:text-slate-400 mt-2 text-sm">
    Dukungan Dark Mode adalah salah satu fitur utama. Cukup berikan awalan `dark:` pada elemen Anda.
  </p>
...
```html
<!-- Kita berikan class 'dark' secara paksa pada elemen pembungkus terluar -->
<div class="dark bg-gray-900 p-8 rounded-xl flex justify-center">
  
  <!-- Komponen Card kita di dalam (Akan mengira bahwa Dark Mode sedang aktif!) -->
  <div class="bg-white dark:bg-slate-800 rounded-lg px-6 py-8 ring-1 ring-slate-900/5 shadow-xl max-w-sm">
    ...
    <p class="text-slate-500 dark:text-slate-400 mt-2 text-sm">
      Karena div terluar menggunakan class <b>dark</b>, maka semua class yang berawalan <code>dark:</code> pada elemen anak-anaknya secara otomatis dieksekusi.
    </p>
  </div>
...
<div class="preview-box">
<!-- Memaksa class dark di container parent -->
<div class="dark bg-gray-900 p-8 rounded-xl flex justify-center">
  <div class="bg-white dark:bg-slate-800 rounded-lg px-6 py-8 ring-1 ring-slate-900/5 shadow-xl max-w-sm">
    <span class="inline-flex items-center justify-center p-2 bg-indigo-500 rounded-md shadow-lg">
      <svg class="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
