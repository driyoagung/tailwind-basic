...
```html
<button class="flex items-center gap-2 bg-blue-600 text-white px-6 py-2 rounded-lg font-bold">
  <!-- Ikon Loading -->
...
```html
<!-- Perhatikan indikator merah kecil di sudut kanan atas amplop -->
<span class="relative inline-block mt-4 ml-4">
  ...
  <span class="bg-gray-200 rounded-lg p-3 inline-block">📩 Pesan</span>
</span>
```
