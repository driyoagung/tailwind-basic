...
<nav class="bg-white border-b shadow-sm rounded-lg">
  <div class="container mx-auto flex items-center justify-between px-4 py-3">
    <a href="#" class="text-xl font-bold text-blue-600">MyApp</a>
    <ul class="hidden md:flex items-center gap-6 text-gray-600 font-medium">
      <li><a href="#" class="hover:text-blue-600 transition">Home</a></li>
...
```html
<div class="w-64 bg-slate-900 text-white min-h-[400px] rounded-xl p-4 flex flex-col">
  ...
  <div class="border-t border-slate-700 pt-4 mt-4">
    <div class="flex items-center gap-3 px-3">
      ...
      <div>
        ...
        <p class="text-xs text-slate-400">admin@app.com</p>
      </div>
    </div>
  </div>
</div>
...
<div class="relative inline-block">
  <button class="bg-white border px-4 py-2 rounded-lg font-medium text-gray-700 hover:bg-gray-50 transition flex items-center gap-2">
