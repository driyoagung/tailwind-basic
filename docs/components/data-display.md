---
title: "Data Display: Table, Pagination, Accordion & More"
description: "Komponen tampilan data: table, pagination, accordion, skeleton loading, dan tooltip."
---
...
<Preview :html='`<div class="overflow-x-auto border rounded-lg shadow-sm">
...
<Preview :html='`<nav class="flex items-center gap-1">
...
<Preview :html='`<div class="max-w-lg border rounded-lg divide-y">
...
<Preview :html='`<div class="flex gap-8 p-8">
