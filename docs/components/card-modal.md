...
```html
<div class="max-w-sm bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-xl transition-shadow">
...
<div class="max-w-sm bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-xl transition-shadow mx-auto">
  <img src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=500" alt="Laptop" class="w-full h-48 object-cover">
  <div class="p-6">
    <span class="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded-full">Teknologi</span>
    <h3 class="mt-3 text-xl font-bold text-gray-900">Memulai Karir Web Developer</h3>
...
```html
<div class="flex items-center gap-4 bg-white p-4 rounded-xl shadow-md border max-w-md">
...
```html
<div class="relative bg-black/50 p-8 rounded-xl min-h-[300px] flex items-center justify-center">
...
```html
<div class="relative bg-black/40 rounded-xl min-h-[300px] flex overflow-hidden">
