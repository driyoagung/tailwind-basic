---
title: "Layout Project: Dashboard Admin"
description: Kerangka lengkap dashboard admin dengan sidebar, topbar, stat cards, dan tabel data.
---
...
<Preview :html='`<div class="flex h-[600px] bg-gray-100 rounded-xl overflow-hidden border shadow-lg">
  <!-- SIDEBAR -->
  ...
  <div class="flex-1 flex flex-col overflow-hidden">
    ...
    <header class="bg-white border-b px-6 py-3 flex items-center justify-between flex-shrink-0">
      ...
      <div class="flex items-center gap-4">
        <input type="text" placeholder="Cari..." class="border border-gray-300 bg-white rounded-lg px-3 py-1.5 text-sm w-48 text-gray-700 outline-none focus:ring-2 focus:ring-blue-500">
